...
document.getElementById('settings-form').addEventListener('submit', function(event) {
    ...
    const profileInfo = document.getElementById('profile-info').value;

    // For demonstration purposes, we'll just log these values to the console
    ...
    // You can also add code here to save these settings, e.g., to a server or local storage
